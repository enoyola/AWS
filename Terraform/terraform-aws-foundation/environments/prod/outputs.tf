...
output "read_replica_endpoint" {
  ...
  value       = var.create_rds && var.create_read_replica ? module.rds[0].read_replica_endpoint : null
  sensitive   = true
}
...
output "target_group_arn" {
  ...
  value       = var.create_load_balancer ? module.load_balancer[0].target_group_arn : null
}
